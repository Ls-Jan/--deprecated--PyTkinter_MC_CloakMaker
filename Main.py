...
#图片自由裁剪按钮
freeCutting_Front=Checkbutton(frame_CropperFront, text = "自由裁剪")
freeCutting_Front.myVar=IntVar()
freeCutting_Front.config(variable=freeCutting_Front.myVar)
freeCutting_Back=Checkbutton(frame_CropperBack, text = "自由裁剪")
